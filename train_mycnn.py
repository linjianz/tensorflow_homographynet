...
save_iter = 2000
batch_size = 64
pairs_per_img = 1  # keep 1 is better
lr_base = 5e-6
...
dir_model = 'model/model_mycnn_2/' + dir0  # dir of model to be saved
log_train = 'log/log_mycnn_2/train_' + dir0  # tensorboard
log_val = 'log/log_mycnn_2/val_' + dir0  # tensorboard
...
def generate_data(img_path):
    ...
    while i < pairs_per_img + 1:
        ...
        # cv2.imshow('window2', img_perburb)
        # cv2.imshow('window3', img_patch)
        # cv2.imshow('window4', img_perburb_patch)
        # cv2.waitKey()
